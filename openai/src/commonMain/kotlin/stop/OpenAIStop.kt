package io.kory.openai.stop

import io.kory.openai.serializer.stop.OpenAIStopSerializer
 ...
 *
 * @sample examples.openai.completions.stop.createOpenAIStop
 *
 * @see io.kory.openai.api.OpenAIChatCompletionRequest.stop
 */
