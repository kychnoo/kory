package io.kory.openai.completions.serialization
...
/**
 * Custom serializer for [io.kory.openai.completions.message.content.OpenAIChatCompletionContent].
 *
 * Handles the dual serialization format:
 * - [io.kory.openai.completions.message.content.OpenAIChatCompletionContent.Text] → JSON string (e.g. `"hello"`)
 * - [io.kory.openai.completions.message.content.OpenAIChatCompletionContent.Parts] → JSON array (e.g. `[{"type":"text","text":"hello"}]`)
 *
