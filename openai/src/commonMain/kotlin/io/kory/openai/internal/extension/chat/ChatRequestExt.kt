package io.kory.openai.internal.extension.chat
...
import io.kory.openai.internal.extension.toOpenAIReasoningEffort
 ...
 *
 * Maps:
 * - Chat messages → [OpenAIMessageParam][io.kory.openai.completions.message.OpenAIMessageParam] list
 * - Tools → [OpenAiChatCompletionFunctionTool] list with JSON Schema parameters
 * - Reasoning config → [OpenAIReasoningEffort][io.kory.openai.shared.param.OpenAIReasoningEffort]
 *
