 ...
 *
 * Only set this when [io.kory.openai.completions.dto.OpenAIChatCompletionRequest.stream] is `true`.
 *
 ...
 *
 * @see io.kory.openai.completions.dto.OpenAIChatCompletionRequest.streamOptions
 */
@Serializable
