 ...
 *
 * @sample io.kory.core.samples.chat.content.createMessageWithTextContent
 * @sample io.kory.core.samples.chat.content.processContentResponse
 */
@Serializable
sealed interface Content {
    /**
     * Content that can be sent to a model in a request.
     * @sample io.kory.core.samples.chat.content.createRequestContent
     * @sample io.kory.core.samples.chat.content.convertToRequest
     */
    @Serializable
     ...
     * @sample io.kory.core.samples.chat.content.receivingContentInStreaming
     */
    @Serializable
     ...
     *
     * @sample io.kory.core.samples.chat.content.useToolCallAndToolResult
     */
