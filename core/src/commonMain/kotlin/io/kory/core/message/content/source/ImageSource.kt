 ...
 *
 * @sample io.kory.core.samples.chat.basicChatCreationWithDsl
 */
sealed interface ImageSource {
     ...
     *
     * @sample io.kory.core.samples.chat.content.source.loadImageSourceFromUrl
     */
    data class Url(
        val url: String
    ) : ImageSource
     ...
     *
     * @sample io.kory.core.samples.chat.content.source.createSourceWithBytes
     */
    data class Bytes(
        val bytes: ByteArray,
     ...
     * @property mimeType The MIME type (default: `"image/jpeg"`).
     *
     * @sample io.kory.core.samples.chat.content.source.createSourceFromPath
     */
    data class FilePath(
        val path: String,
    ...
    companion object {
         ...
         *
         * @sample io.kory.core.samples.chat.content.source.detectImageSource
         */
