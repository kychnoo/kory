...
internal class ImageSourceTest {
    ...
    fun testFromStringHttp() {
        ...
        assertEquals("http://example.com/img.png", (source as ImageSource.Url).url)
    }
    ...
    fun testFromStringHttps() {
        ...
        assertTrue(source is ImageSource.Url)
        assertEquals("https://example.com/img.png", (source as ImageSource.Url).url)
    }
    ...
    fun testFromStringBase64() {
        ...
        val bytes = source as ImageSource.Bytes
    ...
    fun testFromStringFilePath() {
        ...
        assertEquals("/path/to/image.jpg", (source as ImageSource.FilePath).path)
    }
