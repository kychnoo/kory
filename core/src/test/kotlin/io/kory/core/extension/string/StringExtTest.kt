...
internal class StringExtTest {
    ...
    fun testAsSystemMessage() {
        ...
        assertEquals("system prompt", (msg.content as Content.Text).text)
    }
    ...
    fun testAsUserMessage() {
        ...
        assertTrue(msg.content is Content.Text)
        assertEquals("hello", (msg.content as Content.Text).text)
    }
    ...
    fun testAsAssistantMessage() {
        ...
        assertTrue(msg.content is Content.Text)
        assertEquals("response", (msg.content as Content.Text).text)
    }
}
