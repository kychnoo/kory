...
class KoryHttpClient private constructor(
    ...
    companion object {
        ...
        fun create(config: KoryHttpClientConfig): KoryHttpClient {
            ...
            ?: error("No Kory Http Engine found. Either pass `engineFactory` explicitly in " +
            "KoryHttpClientConfig, or add an engine dependency such as `kory-ktor-cio` to your module")
